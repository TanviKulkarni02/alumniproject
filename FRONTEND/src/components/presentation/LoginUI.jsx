  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-purple-300 to-lavender-200 px-6 py-8">
      <div className="bg-purple-50 p-8 rounded-lg shadow-md w-full max-w-md">
        <h2 className="text-2xl sm:text-3xl font-semibold text-center mb-4 text-purple-700">Login</h2>
        <form>
          ...
          <button
            type="button"
            onClick={handleLogin}
            className="w-full py-2 bg-purple-600 text-white text-sm sm:text-base rounded-lg hover:bg-purple-700 transition"
          >
            Login
          </button>
        </form>
